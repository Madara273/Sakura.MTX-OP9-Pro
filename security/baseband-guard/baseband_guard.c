...
static int __init bbg_init(void)
{
	...
	pr_info("baseband_guard: module initialized successfully\n");
	pr_info("baseband_guard: repo: %s\n", __stringify(BBG_REPO));
	pr_info("baseband_guard: version: %s\n", __stringify(BBG_VERSION));
	return 0;
}
